    ...
    return (
        <>
            <Flex  className='backdrop-blur-lg bg-white/30 text-blue-50 z-10 fixed top-0 left-0 right-0' >
                <Flex style={{width: '100%'}} justify="space-between" className='px-12 mt-8 '>
                    <Logo/>
                    { <Button ref={ref} type={'link'} size={"large"} className='text-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-blue-50 hover:text-black'>Create Profile/Login</Button>}
